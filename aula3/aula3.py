...
"""
texto = "Essa é uma frase muito grande e que não deve ter repetição, mas toda frase grande pode ter repetição"

texto_vetor = texto.split(" ")

contador_palavras = {}

for p in texto_vetor:
    if p in contador_palavras:
...
"""
while True:
    palavra = input("Digite uma palacra: ").lower()
